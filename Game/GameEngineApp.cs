...
namespace AOT
{
	...
	public class GameEngineApp : EngineApp
	{
		...
		protected override bool OnCreate()
		{
			...
			Control programLoadingWindow = ControlDeclarationManager.Instance.CreateControl(Dialogs.ProgrammLoading);
		...
		string GetAutorunMapName()
		{
			...
			if( !WebPlayerMode && PlatformInfo.Platform != PlatformInfo.Platforms.Android )
			{
			...
			bool noChangeWindows )
		{
			...
			if( !noChangeWindows )
			{
				...
				mapLoadingWindow = ControlDeclarationManager.Instance.CreateControl(Dialogs.MapLoading);
		...
		public bool WorldLoad( string fileName )
		{
			...
			{
				worldLoadingWindow = ControlDeclarationManager.Instance.CreateControl(Dialogs.WorldLoading);
		...
		public bool WorldSave( string fileName )
		{
			...
			//world saving window
			{
				worldSavingWindow = ControlDeclarationManager.Instance.CreateControl(Dialogs.WorldSaving);
			...
			WorldType worldType, string mapVirtualFileName )
		{
			...
			//show map loading window
			{
				Control mapLoadingWindow = ControlDeclarationManager.Instance.CreateControl(Dialogs.MapLoading);
				if( mapLoadingWindow != null )
				{
